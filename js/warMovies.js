...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function loadPageTwo() {
        const url = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&with_genres=10752&language=en-US&page=2`;
    ...
    function loadPageThree() {
        const url = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&with_genres=10752&language=en-US&page=3`;
    ...
    function loadPageFour() {
        const url = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&with_genres=10752&language=en-US&page=4`;
    ...
    function loadPageFive() {
        const url = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&with_genres=10752&language=en-US&page=5`;
    ...
    function loadPageSix() {
        const url = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&with_genres=10752&language=en-US&page=6`;
    ...
    function loadPageSeven() {
        const url = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&with_genres=10752&language=en-US&page=7`;
